			...
			<div class="itembox wowbox">
				...
				<div class="wow-admin-col">
					<div class="wow-admin-col">
						...
						<div class="wow-admin-col-6">
							Icon position: <span class="dashicons dashicons-lock" style="color:#37c781;"></span><br />
							<select disabled>
								<option>Before Menu item</option>							
							</select>
						</div>
						<div class="wow-admin-col-6">
							Icon color: <span class="dashicons dashicons-lock" style="color:#37c781;"></span><br />
							<select disabled>
		...
		<div id="wow-rightcol">
			...
			<div class="wowbox">
				...
				<div class="wow-admin wow-plugins">
					<p>We will be very grateful if you <a href="https://wordpress.org/plugins/wow-icons/" target="_blank"><b>leave a review about the plugin</b></a>.</p>
